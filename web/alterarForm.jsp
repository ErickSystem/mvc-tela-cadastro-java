...
<html>
  ...
  <body>
    ...
    <form method="GET" action="Controle" name="Formulario"> 
	...
	<fieldset id="user-details">  
            ...
            <input type="text" name="nomeCliente" value="<%=c.getNomeCliente()%>" id="nomeCliente" placeholder="Digite aqui" maxlength="40"/>
            <small class="small-nome small-form"></small>
            <br><br> 
            <label for="email">E-mail:</label>
            <input type="text" name="email" value="<%=c.getEmail()%>" id="email" placeholder="Ex: nome@hotmail.com.br" maxlength="30"/> 
            <small class="small-email small-form"></small>
            <br><br>
            <label for="manequim">Manequim:</label>
            <input type="text" name="manequim" value="<%=c.getManequim()%>" id="manequim" placeholder="Digite aqui" maxlength="2" /> 
            <br>
            <label for="endereco">Endereço:</label>
            <input type="text" name="endereco" value="<%=c.getEndereco()%>" id="endereco" placeholder="Digite aqui" /> 
            <br>
            <label for="telefone">Telefone:</label>
            <input type="text" name="telefone" value="<%=c.getTelefone()%>" id="telefone" placeholder="Digite aqui" maxlength="09"/> 
            <br>
	</fieldset>
        <fieldset>
            <input type="submit" class="Atualiza"  id="enviar" value="Atualizar" />
            <br> 
            <a href="AtualizaLista" class="listar">Listar clientes</a>
            
            <input hidden="true" type="text" name="id" value="<%=c.getId()%>" />
            <input hidden="true" type="text" name="acao" value='ABD' />
        </fieldset>    
    </form>
